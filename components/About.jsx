    ...
    <section className="py-12 xl:pt-0 xl:pb-24" ref={ref}>
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row">
          ...
          >
            <h2 className="h2 mb-[38px]">Sobre Mari's Hotel</h2>
            <p>
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iste
              mollitia exercitationem fugit alias laboriosam accusantium culpa,
              quis sint doloribus perferendis, sequi nemo pariatur, impedit amet
              at!
            </p>
            ...
            <p className="mb-10">
              ...
              Reiciendis, earum animi ipsam odit cum libero id nesciunt.
